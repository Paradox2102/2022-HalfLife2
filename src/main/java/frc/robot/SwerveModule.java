...
public class SwerveModule {
  ...
  private double getVelocityMPS() {
    return m_driveEncoder.getVelocity() * Constants.k_RPMtoMPS;
  }
  ...
  private void setSpeed(double speed) {
    m_driveMotor.getPIDController().setReference(speed / Constants.k_RPMtoMPS, CANSparkMax.ControlType.kVelocity);
  }
